...
- Boundary conditions at the free surface lead to the Rayleigh equation:
  $$\left(2 - \beta^2\right)^2 - 4\sqrt{1 - \beta^2}\,\sqrt{1 - \alpha^2 \beta^2} = 0$$
  where $\beta = c_R / V_S$ and $\alpha = V_P / V_S$.
